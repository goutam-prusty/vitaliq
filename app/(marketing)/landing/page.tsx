...
import { ArrowRight, Activity, Code, Database, Layout, Shield, Cpu, RefreshCw, Layers } from "lucide-react";
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-[rgb(var(--bg))]/80 border-b border-[rgb(var(--border))]/50">
        <div className="flex items-center justify-between p-5 max-w-7xl mx-auto">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-semibold text-lg tracking-tight">Vitaliq</span>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/sign-in" className="text-sm font-medium text-[rgb(var(--muted))] hover:text-[rgb(var(--text))] transition-colors">
              Sign In
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-6 py-20 space-y-36 relative z-10">
          ...
          <div className="relative rounded-2xl border border-[rgb(var(--border))]/80 bg-[rgb(var(--panel))] overflow-hidden shadow-2xl shadow-[rgb(var(--accent))]/5 transition-all duration-300 hover:border-[rgb(var(--border))]">
            ...
            <div className="flex items-center justify-between h-12 px-4 border-b border-[rgb(var(--border))]/60 bg-[rgb(var(--panel-soft))]/60 backdrop-blur-sm select-none">
              ...
              <div className="flex-1 max-w-md mx-auto h-7 px-4 flex items-center justify-center rounded bg-[rgb(var(--bg))]/90 text-xs font-mono text-[rgb(var(--muted))] border border-[rgb(var(--border))]/50 shadow-inner">
                <span className="opacity-50 mr-1 select-none">https://</span>vitaliq.app/dashboard
              </div>
        ...
        <section className="space-y-16">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl font-extrabold sm:text-4xl tracking-tight">Built for Performance</h2>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl border border-[rgb(var(--border))]/85 bg-[rgb(var(--panel))] hover:bg-[rgb(var(--panel-soft))]/40 space-y-4 transition-all duration-300 hover:-translate-y-1 hover:border-[rgb(var(--accent-soft))] hover:shadow-lg hover:shadow-black/5 group">
              ...
              <h3 className="font-bold text-xl tracking-tight">Next.js 15 & React 19</h3>
            ...
            <div className="p-8 rounded-2xl border border-[rgb(var(--border))]/85 bg-[rgb(var(--panel))] hover:bg-[rgb(var(--panel-soft))]/40 space-y-4 transition-all duration-300 hover:-translate-y-1 hover:border-[rgb(var(--accent-soft))] hover:shadow-lg hover:shadow-black/5 group">
              ...
              <h3 className="font-bold text-xl tracking-tight">Drizzle ORM & Postgres</h3>
              <p className="text-sm text-[rgb(var(--muted))] leading-relaxed">
            ...
            <div className="p-8 rounded-2xl border border-[rgb(var(--border))]/85 bg-[rgb(var(--panel))] hover:bg-[rgb(var(--panel-soft))]/40 space-y-4 transition-all duration-300 hover:-translate-y-1 hover:border-[rgb(var(--accent-soft))] hover:shadow-lg hover:shadow-black/5 group">
              ...
              <h3 className="font-bold text-xl tracking-tight">Clerk Authentication</h3>
              <p className="text-sm text-[rgb(var(--muted))] leading-relaxed">
        ...
        <section className="max-w-4xl mx-auto p-10 rounded-3xl bg-[rgb(var(--panel-soft))]/50 border border-[rgb(var(--border))]/60 relative overflow-hidden backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3.5 mb-8">
            ...
            <div>
              <h2 className="text-2xl font-bold tracking-tight">Project Architecture Note</h2>
              <p className="text-xs text-[rgb(var(--muted))]">Engineered with Clean Architecture Principles</p>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-8 pt-4 border-t border-[rgb(var(--border))]/30">
              <div className="space-y-2">
                ...
                <p className="text-xs leading-relaxed">
                  Data access is encapsulated in isolated Repository layers. All core logic stays decoupled inside domain classes like <code className="text-xs font-mono text-[rgb(var(--accent))] bg-[rgb(var(--panel))] px-1 py-0.5 rounded border border-[rgb(var(--border))]/50">HealthDomain</code>, making the core math testable without framework wrappers.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-[rgb(var(--text))] font-semibold">
                ...
                <p className="text-xs leading-relaxed">
                  Calculations, trends, and target tracking are derived algorithmically. Dynamic visualizations utilize customized <code className="text-xs font-mono text-[rgb(var(--accent))] bg-[rgb(var(--panel))] px-1 py-0.5 rounded border border-[rgb(var(--border))]/50">Recharts</code> layouts optimized for critical clinical values.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-[rgb(var(--text))] font-semibold">
      ...
      <footer className="border-t border-[rgb(var(--border))]/40 py-12 text-center text-sm text-[rgb(var(--muted))] relative z-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Activity className="h-4 w-4 text-[rgb(var(--accent))]" />
            <span className="font-semibold text-xs tracking-wider uppercase text-[rgb(var(--text))]">Vitaliq</span>
          </div>
          <p className="text-xs">Built as a production-grade portfolio demonstration.</p>
        </div>
      </footer>
    </div>
  );
